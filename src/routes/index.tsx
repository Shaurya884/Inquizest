  ...
  head: () => ({
    meta: [
      { title: "INQUIZEST 3.0 — Scroll the Universe" },
      {
        name: "description",
        content:
          "INQUIZEST 3.0: a cinematic, scroll-controlled universe of 20 events driven by two invisible radial mechanisms.",
      },
      { property: "og:title", content: "INQUIZEST 3.0 — Scroll the Universe" },
      {
        property: "og:description",
        content:
          "Scroll becomes the control input: black collapses into light, the logo is revealed from nothing, then 20 events rotate through an invisible mechanism.",
      },
